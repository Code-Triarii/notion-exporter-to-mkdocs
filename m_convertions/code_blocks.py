def notion_code_to_markdown(code_content: str, notion_language: str):
    """
    Convert a Notion code block to a Markdown code block.
    This function takes the content of a code block and its language as used in Notion,
    and returns the corresponding Markdown formatted code block with proper syntax highlighting.
    If the language is not recognized, it defaults to a generic code block without language-specific highlighting.
